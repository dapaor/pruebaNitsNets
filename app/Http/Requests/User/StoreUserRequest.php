...
class StoreUserRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'user.email' => 'required|string|email|unique:users,email|max:100',
            'user.password' => 'required|string|max:100|min:8'
        ];
    }
    ...
    {
        return [
            'user.name.required' => 'El :attribute es necesario para el registro del usuario',
